...
function decodeMessageNode(stanza, meId, meLid) {
    ...
    const key = {
        ...
        fromMe,
        id: msgId,
        senderLid: ((_f = stanza === null || stanza === void 0 ? void 0 : stanza.attrs) === null || _f === void 0 ? void 0 : _f.sender_lid) || (0, WABinary_1.jidNormalizedUser)(chatId),
        senderPn: ((_g = stanza === null || stanza === void 0 ? void 0 : stanza.attrs) === null || _g === void 0 ? void 0 : _g.sender_pn) || (0, WABinary_1.jidNormalizedUser)(chatId),
        participant,
        participantLid,
        'server_id': (_h = stanza.attrs) === null || _h === void 0 ? void 0 : _h.server_id
    };
    const fullMessage = {
        key,
    ...
    if (msgType === 'newsletter') {
        fullMessage.newsletterServerId = +((_j = stanza.attrs) === null || _j === void 0 ? void 0 : _j.server_id);
    }
    if (key.fromMe) {
